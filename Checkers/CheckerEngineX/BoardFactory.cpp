...
namespace BoardFactory {
    ...
    void setUpPosition(Board &board, Position pos) {
        ...
        board.getPosition().key = Zobrist::generateKey(board.getPosition());
    ...
    void setUpStartingPosition(Board &current) {
        ...
        pos.key = Zobrist::generateKey(current.getPosition());
    }
    ...
    void getOpeningPosition(int index, Board &board) {
        ...
        pos.key = Zobrist::generateKey(board.getPosition());
        myStream.close();
    }
