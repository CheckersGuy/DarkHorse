...
if __name__ == "__main__":
    batch_size = 8192 
    epochs = 145
    model = Experimental.Network(run_name ="wdlandeval")
    data_loader = Experimental.LitDataModule(train_data="/mnt/e/evalfilter3.tbeval.rescored.samples",
    ...
    trainer.fit(model, data_loader,ckpt_path ="Networks/lowlr.ckpt");
